...
Knockout bracket generation (Phase 6), jury/organizer/coin-flip tie resolution (Phase 7), and prize payout (Phase 8) are still not started — a tournament's groups can now fully resolve, but nothing yet turns that into a bracket or a close-out.
